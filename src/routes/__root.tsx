...
import { Footer, Header, WhatsAppFab } from "../components/chrome";
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "MASH ELITE — Discover. Stay. Explore." },
      {
        ...
        content:
          "Coastal accommodation, real estate, tours and transfers across Kenya's north coast. Book directly on WhatsApp.",
      },
